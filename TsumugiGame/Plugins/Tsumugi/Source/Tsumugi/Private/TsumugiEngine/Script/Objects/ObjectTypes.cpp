#include "TsumugiEngine/Script/Objects/ObjectTypes.h"
...
const tchar* ObjectTypeToTString(const ObjectType objectType) {
    ...
    static const std::unordered_map<object::ObjectType, const tchar*> Table = {
        ...
        { object::ObjectType::kBuiltinClass, TT("kBuiltinClass") },
        { object::ObjectType::kBuiltinInstance, TT("kBuiltinInstance") },
...
const char* ObjectTypeToString(const ObjectType objectType) {
    ...
    static const std::unordered_map<object::ObjectType, const char*> Table = {
        ...
        { object::ObjectType::kBuiltinClass, ("kBuiltinClass") },
        { object::ObjectType::kBuiltinInstance, ("kBuiltinInstance") },
